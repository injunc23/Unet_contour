...
if __name__ == "__main__":
    ...
    TEST_VIDEO = "/content/drive/MyDrive/Research_models/ultrasound_videos/test/0917/DAT_DICOM/Midsaggital_Videos/Horizontal_Flip/0917_M_G1_001.mp4"
    MODEL_PATH = "tongue_tracker_unet.pth"
